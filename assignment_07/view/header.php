...
<head>
    ...
    <style>
        ...
        aside #handle {float: right; width:145px; height: 35px; margin: 5px 0;}
...
<main>
    ...
    <aside>
        <form action="" method="post">
            <button id="handle" name="btn_transfer">Transfer</button>
            <button id="handle" name="btn_change_pass">Change Password</button>
            <button id="handle" name="btn_logout">Logout</button>
        </form>
    </aside>